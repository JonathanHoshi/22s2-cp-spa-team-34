...
class WhilePatternTable : public IWhilePatternAdder, public IWhilePatternGetter {
private:
...
public:
    ...
    void addWhilePattern(const int& stmtNum,
        const std::unordered_set<std::string>& val) override;
};
