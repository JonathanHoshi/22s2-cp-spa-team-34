...
class ModifiesStrategy : public ClauseStrategy {
protected:
    IModifiesGetter* pkbInterface;
    bool isProcedure;
    ...
    void setPKBInterface(IModifiesGetter* pkbInterface);

public:
    ModifiesStrategy();
    explicit ModifiesStrategy(bool isProcedure);
    explicit ModifiesStrategy(IModifiesGetter* pkbInterface);
    ModifiesStrategy(IModifiesGetter* pkbInterface, bool isProcedure);
};
