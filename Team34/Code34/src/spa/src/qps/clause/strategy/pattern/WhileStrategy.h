...
class WhileStrategy : public ClauseStrategy {
protected:
    IWhilePatternGetter* pkbInterface;
    ...
    void setPKBInterface(IWhilePatternGetter* pkbInterface);

public:
    WhileStrategy();
    explicit WhileStrategy(IWhilePatternGetter* pkbInterface);
};
