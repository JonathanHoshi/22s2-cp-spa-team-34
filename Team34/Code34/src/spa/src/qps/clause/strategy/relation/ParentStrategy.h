...
class ParentStrategy : public ClauseStrategy {
protected:
    IParentGetter* pkbInterface;
    bool isTransitive;
    ...
    void setPKBInterface(IParentGetter* pkbInterface);

public:
    ParentStrategy();
    explicit ParentStrategy(bool isTransitive);
    explicit ParentStrategy(IParentGetter* pkbInterface);
    ParentStrategy(IParentGetter* pkbInterface, bool isTransitive);
};
