...
class IfStrategy : public ClauseStrategy {
protected:
    IIfPatternGetter* pkbInterface;
    ...
    void setPKBInterface(IIfPatternGetter* pkbInterface);

public:
    IfStrategy();
    explicit IfStrategy(IIfPatternGetter* pkbInterface);
};
