...
class UsesStrategy : public ClauseStrategy {
protected:
    IUsesGetter* pkbInterface;
    bool isProcedure;
    ...
    void setPKBInterface(IUsesGetter* pkbInterface);

public:
    UsesStrategy();
    explicit UsesStrategy(bool isProcedure);
    explicit UsesStrategy(IUsesGetter* pkbInterface);
    UsesStrategy(IUsesGetter* pkbInterface, bool isProcedure);
};
