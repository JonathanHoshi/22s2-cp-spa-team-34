...
class CallsStrategy : public ClauseStrategy {
protected:
    ICallsGetter* pkbInterface;
    bool isTransitive;
    ...
    void setPKBInterface(ICallsGetter* pkbInterface);

public:
    CallsStrategy();
    explicit CallsStrategy(bool isTransitive);
    explicit CallsStrategy(ICallsGetter* pkbInterface);
    CallsStrategy(ICallsGetter* pkbInterface, bool isTransitive);
};
