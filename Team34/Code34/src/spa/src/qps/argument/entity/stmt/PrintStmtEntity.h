...
public:
    inline static const std::string TYPE_NAME = "print";

    PrintStmtEntity(std::string name, std::string attrRef);
    PrintStmtEntity(IStmtGetter* pkbInterface, std::string name, std::string attrRef);
