...
public:
    inline static const std::string TYPE_NAME = "read";

    ReadStmtEntity(std::string name, std::string attrRef);
    ReadStmtEntity(IStmtGetter* pkbInterface, std::string name, std::string attrRef);
